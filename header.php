...
include_once('php/ge_functions.php');
?>
<!DOCTYPE html>
...
<script>
  ...
  <link rel="stylesheet" type="text/css" href="<?PHP echo get_template_directory_uri(); ?>/css/ge-styles.css" />
  <link rel="stylesheet" type="text/css" href="<?PHP echo get_template_directory_uri(); ?>/css/ge-footer.css" />
